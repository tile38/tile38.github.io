...
class SideNav extends React.Component {
  ...
  getLocalizedCategoryString(category) {
    // melbania: render "Commands" as Category for commands pages in secondary nav on small screens
    category =
      this.props.current.sidebar_label === "__no_label" ? "Commands" : category;
  ...
  renderItemLink = (linkItem) => {
    ...
    const itemClasses = classNames(
      `navListItem${
        linkMetadata.sidebar_label === "__no_label" ? " hide" : "" //melbania
      }`,
      {
        navListItemActive:
          linkMetadata.id === this.props.current.id ||
          // melbania: make 'Commands' link in sidebar active for commands pages
          (linkMetadata.id == "commands/index" &&
