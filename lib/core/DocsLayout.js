...
class DocsLayout extends React.Component {
  getRelativeURL = (from, to) => {
    /* MELBANIA: fix breaking Commands page url problem: using index makes our linking schema preservation strategy work, but breaks this functionality for the Commands page, which does not originate in the docs/ directory */
    to = to === "commands/index" ? "commands/" : to;
    /* end MELBANIA */
      ...
      >
        <div className="docMainWrapper wrapper">
          ...
          <Container className="mainContainer docsContainer">
            ...
            {/* MELBANIA: don't show prev/next nav buttons on individual command documentation pages */}
            {!metadata.localized_id.startsWith("commands/") && (
              <div className="docs-prevnext">
                ...
                {/*MELBANIA: check if next doc is the aof commands page ... don't show 'nex' link if it is */}
                {metadata.next_id && metadata.next_id !== "commands/aof" && (
                  <a
